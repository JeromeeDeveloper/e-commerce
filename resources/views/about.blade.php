            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="{{ route('shop') }}">Home</a></li>
                            <li class="scroll-to-section"><a href="{{ route('shop')}}">Men's</a></li>
                            <li class="scroll-to-section"><a href="{{ route('shop')}}">Women's</a></li>
                            <li class="scroll-to-section"><a href="{{ route('shop')}}">Kid's</a></li>
                            {{-- <li class="scroll-to-section"><a href="{{ route('list.name')}}">Shop</a></li> --}}
                            <li class="submenu">
                                <a href="javascript:;">Pages</a>
                                <ul>
                                    <li><a href="{{ route('about.name') }}" class="active">About Us</a></li>
                                    <li><a href="{{ route('products.name') }}">Products</a></li>
                                    <li><a href="{{ route('singleproduct.name')}}">Single Product</a></li>
